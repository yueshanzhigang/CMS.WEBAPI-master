...
namespace CMS.UI.MultipartRequest
{
    public static class MultipartRequestHelper
    {
        ...
        /// <summary>
        /// ContentType判断，如果请求中包含“multipart/”，返回true
        /// </summary>
        ...
        /// <summary>
        /// 如果一个section的Header是： Content-Disposition: form-data; name="files"; filename="Misc 002.jpg" 那么本方法返回： files
        /// </summary>
        /// <param name="contentDisposition"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 如果一个section的Header是： Content-Disposition: form-data; name="myfile1"; filename="Misc 002.jpg"  那么本方法返回： Misc 002.jpg
        /// </summary>
        /// <param name="contentDisposition"></param>
        /// <returns></returns>
